...
if( isset( $moon_shop_optionsValue[ 'moon-shop-shop-product-page-layout-select' ] ) && $moon_shop_optionsValue[ 'moon-shop-shop-product-page-layout-select' ] == 'fullwidth' ) {
    $category_class = 'col-lg-3 col-sm-6';
} else {
    $category_class = 'col-lg-4 col-sm-6';
} ?>

<div class="<?php echo esc_attr( $category_class ); ?> product-category">
    <div <?php wc_product_cat_class( 'sin-product fix' , $category ); ?>>
        <?php
        /**
