...
?>
    ...
    if( !empty( $page_title ) ) :
        ...
        <div
            class="wishlist-title <?php echo ( $wishlist_meta[ 'is_default' ] != 1 && $is_user_owner ) ? 'wishlist-title-with-form' : '' ?> cart-page-title text-center">
    ...
    <table class="shop_table cart wishlist_table table-cart data-table table"
    ...
    <tr>
        ...
        <th class="product-name">
            ...
            <?php echo apply_filters( 'yith_wcwl_wishlist_view_name_heading' , __( 'Items' , 'moon-shop' ) ) ?>
        ...
        <?php if( $show_price ) : ?>
            ...
            <th class="product-price">
                ...
                <?php echo apply_filters( 'yith_wcwl_wishlist_view_price_heading' , __( 'Price' , 'moon-shop' ) ) ?>
        ...
        <?php if( $show_stock_status ) : ?>
            ...
            <th class="product-stock-stauts">
                ...
                <?php echo apply_filters( 'yith_wcwl_wishlist_view_stock_heading' , __( 'Stock Status' , 'moon-shop' ) ) ?>
    ...
    if( count( $wishlist_items ) > 0 ) :
            ...
            if( $product !== false && $product->exists() ) :
                ...
                <?php if( $show_price ) : ?>
                    ...
                    <td class="product-price">
                        ...
                        if( is_a( $product , 'WC_Product_Bundle' ) ) {
                            ...
                            echo '<p class="price new">' . $product->get_price_html() . '</p>';

                        } else {

                            echo apply_filters( 'yith_free_text' , __( 'Free!' , 'moon-shop' ) );
                ...
                <?php if( $show_stock_status ) : ?>
                    ...
                    <td class="product-stock-status">
                        ...
                        if( $stock_status == 'out-of-stock' ) {
                            ...
                            echo '<span class="wishlist-out-of-stock availabity">' . __( 'Out of Stock' , 'moon-shop' ) . '</span>';

                        } else {

                            $stock_status = "In";

                            echo '<span class="wishlist-in-stock availabity">' . __( 'In Stock' , 'moon-shop' ) . '</span>';
                ...
                <?php if( $show_last_column ): ?>
                    ...
                    <td class="product-add-to-cart">
                        ...
                        if( $show_dateadded && isset( $item[ 'dateadded' ] ) ):
                            ...
                            echo '<span class="dateadded">' . sprintf( __( 'Added on : %s' , 'moon-shop' ) , date_i18n( get_option( 'date_format' ) , strtotime( $item[ 'dateadded' ] ) ) ) . '</span>';
                        ...
                        <?php if( $available_multi_wishlist && is_user_logged_in() && count( $users_wishlists ) > 1 && $move_to_another_wishlist ): ?>
                            ...
                            <select class="change-wishlist selectBox">
                                ...
                                <option value=""><?php _e( 'Move' , 'moon-shop' ) ?></option>
                                ...
                                foreach( $users_wishlists as $wl ):
                                    ...
                                    <option value="<?php echo esc_attr( $wl[ 'wishlist_token' ] ) ?>">
                                        ...
                                        if( $wl[ 'wishlist_privacy' ] == 1 ) {
                                            ...
                                            $wl_privacy = __( 'Shared' , 'moon-shop' );

                                        } elseif( $wl[ 'wishlist_privacy' ] == 2 ) {

                                            $wl_privacy = __( 'Private' , 'moon-shop' );

                                        } else {

                                            $wl_privacy = __( 'Public' , 'moon-shop' );
                        ...
                        <?php if( $is_user_owner && $repeat_remove_button ): ?>
                            ...
                            <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist' , $item[ 'prod_id' ] ) ) ?>"
                               ...
                               title="<?php _e( 'Remove this product' , 'moon-shop' ) ?>"><?php _e( 'Remove' , 'moon-shop' ) ?></a>
                ...
                <?php if( $is_user_owner ): ?>
                    ...
                    <td class="product-remove">
                        ...
                        <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist' , $item[ 'prod_id' ] ) ) ?>"
                           class="remove remove_from_wishlist cart-remove"
                           title="<?php _e( 'Remove this product' , 'moon-shop' ) ?>"><i
        ...
        <tr>
            ...
            <td colspan="<?php echo esc_attr( $column_count ) ?>"
                class="wishlist-empty"><?php _e( 'No products were added to the wishlist' , 'moon-shop' ) ?></td>
            ...
            <?php if( $show_cb ) : ?>
                ...
                <div class="custom-add-to-cart-button-cotaniner">
                    ...
                    <a href="<?php echo esc_url( add_query_arg( array( 'wishlist_products_to_add_to_cart' => '' , 'wishlist_token' => $wishlist_meta[ 'wishlist_token' ] ) ) ) ?>"
                       class="button alt"
                       id="custom_add_to_cart"><?php echo apply_filters( 'yith_wcwl_custom_add_to_cart_text' , __( 'Add the selected products to the cart' , 'moon-shop' ) ) ?></a>
                ...
                <div class="ask-an-estimate-button-container">
                    ...
                    <a href="<?php echo ( $additional_info ) ? '#ask_an_estimate_popup' : $ask_estimate_url ?>"
                       class="btn button ask-an-estimate-button" <?php echo ( $additional_info ) ? 'data-rel="prettyPhoto[ask_an_estimate]"' : '' ?> >
                        ...
                        <?php echo apply_filters( 'yith_wcwl_ask_an_estimate_text' , __( 'Ask for an estimate' , 'moon-shop' ) ) ?>
    ...
    <?php if( $wishlist_meta[ 'is_default' ] != 1 ): ?>
        ...
        <input type="hidden" value="<?php echo esc_attr( $wishlist_meta[ 'wishlist_token' ] ); ?>" name="wishlist_id"
               id="wishlist_id">
    ...
    <div id="ask_an_estimate_popup">
        ...
        <form action="<?php echo esc_url( $ask_estimate_url ); ?>" method="post" class="wishlist-ask-an-estimate-popup">
            ...
            <button class="btn button ask-an-estimate-button ask-an-estimate-button-popup">
                ...
                <?php _e( 'Ask for an estimate' , 'moon-shop' ) ?>
