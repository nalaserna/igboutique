...
if( $customer_orders ) : ?>
    ...
    <h2><?php echo apply_filters( 'woocommerce_my_account_my_orders_title' , __( 'Recent Orders' , 'moon-shop' ) ); ?></h2>
                    ...
                    <td class="<?php echo esc_attr( $column_id ); ?>"
                        ...
                        <?php elseif( 'order-number' === $column_id ) : ?>
                            ...
                            <a href="<?php echo esc_url( $order->get_view_order_url() ); ?>">
                                ...
                                <?php echo _x( '#' , 'hash before order number' , 'moon-shop' ) . $order->get_order_number(); ?>
                        ...
                        elseif( 'order-total' === $column_id ) : ?>
                            <?php echo sprintf( _n( '%s for %s item' , '%s for %s items' , $item_count , 'moon-shop' ) , $order->get_formatted_order_total() , $item_count ); ?>
                        ...
                        elseif( 'order-actions' === $column_id ) : ?>
                            ...
                            $actions = array(
                                'pay' => array(
                                    ...
                                    'name' => __( 'Pay' , 'moon-shop' )
                                ) ,
                                'view' => array(
                                    'url' => $order->get_view_order_url() ,
                                    'name' => __( 'View' , 'moon-shop' )
                                ) ,
                                'cancel' => array(
                                    'url' => $order->get_cancel_order_url( wc_get_page_permalink( 'myaccount' ) ) ,
                                    'name' => __( 'Cancel' , 'moon-shop' )
                                )
                            );
