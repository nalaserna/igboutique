...
$moon_shop_cross = isset($moon_shop_optionsValue['moon-shop-cart-cross-cell']) ? $moon_shop_optionsValue['moon-shop-cart-cross-cell'] : '1';
?>
...
<div class="cart-page-container fix">
    ...
    <form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
        ...
        <div class="table-responsive">
            <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents table-cart data-table table" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class' , 'cart_item' , $cart_item , $cart_item_key ) ); ?>">
                            <td class="product-thumbnail">
                                ...
                                if( !$product_permalink ) {
                                    ...
                                    printf( '<a class="cart-image" href="%s">%s</a>' , esc_url( $product_permalink ) , $thumbnail );
                                }
                                ?>
                            </td>
                            ...
                            <td class="product-name">
                                ...
                                if ( $_product->backorders_require_notification() && $_product->is_on_backorder( $cart_item['quantity'] ) ) {
                                    echo wp_kses_post( apply_filters( 'woocommerce_cart_item_backorder_notification', '<p class="backorder_notification">' . esc_html__( 'Available on backorder', 'moon-shop' ) . '</p>' ) );
                                }
                                ?>
                            </td>

                            <td class="product-price" data-title="<?php _e( 'Price' , 'moon-shop' ); ?>">
                                <?php
                            ...
                            <td class="product-subtotal" data-title="<?php _e( 'Total' , 'moon-shop' ); ?>">
                                <?php
