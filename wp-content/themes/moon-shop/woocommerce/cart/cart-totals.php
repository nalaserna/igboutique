...
<div
    class="payment-details cart_totals  table-responsive <?php if( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
    ...
    <table cellspacing="0" class="shop_table shop_table_responsive">
        ...
        <tr class="cart-subtotal">
            ...
            <th><?php _e( 'Subtotal' , 'moon-shop' ); ?></th>

            <td data-title="<?php esc_attr_e( 'Subtotal' , 'moon-shop' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
    ...
    <div class="wc-proceed-to-checkout procced-checkout text-center">
